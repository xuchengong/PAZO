...
class Trainer(BaseTrainer):
    def __init__(self, params):
        ...
        self.query_loss = vmap(self.compute_loss, in_dims=(0, None, None, None, None, None), randomness='different') # over b samples
            ...
            for i, (x, mask, y, pos) in enumerate(self.train_loader):
                ...
                with torch.no_grad():
                    for j in range(self.num_microbatches):
                        ...
                        l1s = self.query_loss(params_plus, buffers, x, mask, y, pos)
                        l2s = self.query_loss(params_minus, buffers, x, mask, y, pos)
